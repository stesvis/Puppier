...
!(function (n) {
    ...
    var t = {
      ...
      setPosition: function () {
        var n = $(".core-nav-list"),
          e = n.outerHeight() / 2;
        $(window).width() > 920
          ? (n.css("margin-top", -1 * e),
            n.css("top", 0.5 * $(window).height()))
    ...
    var t = {
      ...
      layout: function (n) {
        ...
        if (e > 920) {
          ...
          o.css("margin-top", ""), $(".core-nav-list > li").css("width", "");
      },
    };
    n.exports = t;
  },
  ...
  function (n, e, o) {
    ...
    var t = {
      init: function (n, e) {
        e.container
          ? n.wrapInner("<div class='nav-container'></div>")
          : n.wrapInner("<div class='full-container'></div>"),
        ...
        $(".wrap-core-nav-list > .nav-container").prepend(
          '<button class="toggle-bar core-nav-toggle">' + o + "</button>"
        ),
  ...
  function (n, e, o) {
    ...
    n.exports = function (n, e, o) {
      ...
      return (
        ...
        t(o) &&
          ((w = !!o.leading),
          (u = ($ = "maxWait" in o) ? s(r(o.maxWait) || 0, e) : u),
  ...
  function (n, e, o) {
    ...
    n.exports = function (n) {
      return (
        "symbol" == (void 0 === n ? "undefined" : t(n)) || (r(n) && a(n) == i)
      );
    };
  },
  function (n, e, o) {
  ...
  function (n, e, o) {
    ...
    n.exports = function (n, e) {
      ...
      return (
        ...
        function () {
          return (
            --n > 0 && (o = e.apply(this, arguments)), n <= 1 && (e = void 0), o
          );
        }
      );
    };
    ...
    var i = {
        ...
        e.responsideSlide &&
          ...
          $(window).on(
            ...
            (0, a.default)(function () {
              o.contentHeader(e),
                o.attributesIcon(e),
                $.isFunction(e.onResize) && e.onResize();
            }, 1e3)
          );
      },
      setMode: function (n) {
              ...
              $(window).on("scroll", function () {
                $(window).scrollTop() > e
                  ? ($(".nav-core-sticky").hasClass("on-scroll") ||
                      ($.isFunction(n.onStartSticky) && n.onStartSticky()),
                    $(".nav-core-sticky").addClass("on-scroll"),
                    $(".stand-sticky").css("display", "block"))
                  : ($(".nav-core-sticky").hasClass("on-scroll") &&
                      $.isFunction(n.onEndSticky) &&
                      n.onEndSticky(),
      ...
      topSearch: function (n) {
        ...
        e.length &&
          (e.remove(),
          $(".core-nav").prepend(
            '<div class="wrap-search-top">' + o + "</div>"
          )),
          n.container
              ...
              o > 992
                ? n.container
                  ? ($(".nav-header .nav-container").prepend(
                      "<div class='content-header'>" + e + "</div>"
                    ),
          ...
          $(e).each(function () {
            ...
            switch (
              (void 0 != t &&
                ...
                $(this).find(".megamenu-content").eq(0).css("width", t)),
              e.removeClass("open"),
      ...
      attributesIcon: function (n) {
        ...
        if (t) {
          ...
          "sidebar" == n.layout &&
            e > 992 &&
            $(".core-nav").prepend('<ul class="attributes">' + a + "</ul>"),
            e < 992 &&
              ($(".nav-header").prepend(
                '<ul class="attributes">' + a + "</ul>"
              ),
